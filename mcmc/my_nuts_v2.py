...
from mcmc import my_leapfrog_integrator as leapfrog_impl
...
class NoUTurnSampler(TransitionKernel):
  ...
  def bootstrap_results(self, init_state):
    ...
    with tf.name_scope(self.name + '.bootstrap_results'):
      ...
      ] = leapfrog_impl.process_args(self.target_log_prob_fn, dummy_momentum, init_state)
...
def has_not_u_turn_at_all_index(read_indexes,
                                direction,
                                momentum_state_memory,
                                momentum_right,
                                state_right,
